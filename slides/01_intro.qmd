...
-   Member of ASA BIOP working group on Software Engineering [openstatsware](https://openstatsware.org/)
...
-   Lead and developed multiple internal R packages and Shiny App for data review and data curation
