...
The source files are hosted at https://github.com/pharmarug/pharmasug2024-r-workshop, which is forked from
...
The next event will be on-site, at the Beijing Marriott Hotel Northeast, on August 1st, 2024.
Please note that all the content will be in English, delivered in English and Chinese. 
This event is sponsored/organized by PharamaSUG and advertised also through
the R User Group (RUG) China. Presenters will be Liming Li and Joe Zhu.
...
-   in your rstudio terminal, set the ssh key by `ssh-keygen -t rsa -b 4096 -C "your_email@example.com"`, then use command `cat ~/.ssh/id_rsa.pub` to show your public key, and copy and paste it to https://github.com/settings/keys, with the name "pharmasug-2024-key".
